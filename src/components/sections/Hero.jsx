  ...
  return (
    <section
      ...
      className="relative min-h-screen flex items-center overflow-hidden
                 ...
                 px-6 md:px-12 lg:px-20 pt-24 pb-16"
    >
      <div className="absolute top-0 left-0 w-[500px] h-[500px] rounded-full
                      bg-indigo-500/10 blur-[120px] pointer-events-none -translate-x-1/2 -translate-y-1/3" />
      <div className="absolute bottom-0 right-1/4 w-[300px] h-[300px] rounded-full
                      bg-violet-500/10 blur-[100px] pointer-events-none" />

      <div className="max-w-7xl mx-auto w-full flex flex-col-reverse md:flex-row
                      items-center gap-14 md:gap-10 lg:gap-20">
        ...
        <div className="flex-1 min-w-0">
          ...
          >
            <span className="w-2 h-2 rounded-full bg-indigo-500
                             shadow-[0_0_8px_3px_rgba(99,102,241,0.7)]
                             animate-pulse" />
            Available for Work
          </motion.div>
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl lg:text-6xl font-extrabold
                       ...
                       tracking-tight font-[family-name:var(--font-syne)]"
          >
            Hi, I'm{" "}
          ...
          <motion.p
            ...
            initial="hidden" animate="visible"
            className="text-base sm:text-lg text-gray-500 dark:text-zinc-400
                       font-medium mb-5 h-7 flex items-center gap-1"
          >
            {typedText}
            <span className="inline-block w-0.5 h-5 bg-indigo-500
          ...
          <motion.p
            ...
            initial="hidden" animate="visible"
            className="text-sm sm:text-base text-gray-500 dark:text-zinc-500
        ...
        >
          <div className="relative">
            ...
            <div className="relative p-[3px] rounded-full
                            bg-linear-to-br from-indigo-500 to-violet-600">
              <div className="w-52 h-52 sm:w-64 sm:h-64 lg:w-72 lg:h-72
                              rounded-full overflow-hidden
                              bg-gray-100 dark:bg-[#0f0f1a]
                              flex items-center justify-center">
                <Image
                  src="/myImage.png"
                  alt="Juhairul Islam"
